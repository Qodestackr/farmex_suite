...
export default function FancyTestimonialsSlider({ testimonials }: { testimonials: Testimonial[] }) {
    ...
    return (
        <div className="w-full mx-auto text-center md:mt-6 mt-3">
            {/* Testimonial image */}
...
export function Testimonials() {
    const testimonials = [
        {
            ...
            quote: `Before Farmex Suite, we used to ... reduced piece by piece`,
            name: 'Wilson Gichuhi',
            role: ''
        },
        {
            img: '/images/user/user-06.png',
            quote: `Seamless signups, eSign, and integrations all in one platform has improved our productivity`,
            name: 'Anthony Munene',
            role: ''
        },
        {
            img: '/images/user/user-06.png',
            quote: `The functionality to capture responses is a true game-changer. Even if a user becomes 
            fatigued during sign-up and abandons the process, their information remains stored.`,
            name: 'Ann Kimani',
            role: ''
        },
        {
    ...
    return (
        <section className='w-full mt-6 md:mt-10 bg-forest-green p-7 rounded-md md:p-10'>
