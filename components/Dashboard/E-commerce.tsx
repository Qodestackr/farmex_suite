    ...
    <>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        <CardDataStats title="Total views" total="$3.456K" rate="0.43%" levelUp>
          <svg
            className="fill-primary dark:fill-white tour-logo"
            width="22"
            height="16"
            viewBox="0 0 22 16"
            fill="none"
        ...
        <CardDataStats title="Total Product" total="2.450" rate="2.59%" levelUp>
          <svg
            className="fill-primary dark:fill-white tour-post"
            width="22"
            height="22"
            viewBox="0 0 22 22"
            fill="none"
      ...
      <div className="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5 tour-login tour-footer">
        <ChartOne />
        <ChartTwo />
        <ChartThree />
        <MapOne />
